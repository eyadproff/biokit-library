...
public class ConvertedFingerprintImagesResponse
{
	...
	public ConvertedFingerprintImagesResponse(Message message)
	{
		if(message != null)
		{
	...
	{
		return "ConvertedFingerprintImagesResponse{" + "returnCode=" + returnCode + ", returnMessage='" +
			   returnMessage + '\'' + ", fingerprintImagesMap=" + fingerprintImagesMap + '}';
	}
	
	public String toShortString()
	{
		return "ConvertedFingerprintImagesResponse{" + "returnCode=" + returnCode + ", returnMessage='" +
			   returnMessage + '\'' + ", fingerprintImagesMap.size()=" +
